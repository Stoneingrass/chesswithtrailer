          ...
          <div class="help-modal-body">
            ...
            <section class="help-section">
              ...
              <ul class="help-options-list">
                ...
                <li><strong>Взятие своих фигур "прицепом"</strong> — ведомая фигура может убрать фигуру своего цвета, стоящую на её новой клетке.</li>
                <li><strong>«Прицеп» из 2+ фигур</strong> — можно выбирать более одной ведомой фигуры за ход.</li>
                <li><strong>Рекурсивное формирование "прицепа"</strong> — защитники ведомых фигур также могут подключаться к прицепу цепочкой.</li>
                ...
                <li><strong>Перепрыгивание «прицепом» других фигур</strong> — ведомые фигуры могут перепрыгивать через занятые клетки на своём пути.</li>
                <li><strong>Запрет на перепрыгивание «прицепом» за конём</strong> — конь может перепрыгивать фигуры, но его ведомые не могут перепрыгивать через препятствия.</li>
                <li><strong>Запрет на перепрыгивание для коня с "прицепом"</strong> — конь с ведомыми воспринимается как единая группа и сам конь также не может перепрыгивать через фигуры.</li>
